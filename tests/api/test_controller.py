...
from tests.api.test_novelist import MockNoveListAPI
from tests.api.test_odl import MockODLAPI
...
from tests.api.testing import VendorIDTest
...
from tests.core.mock_external_search import mock_search_index, MockExternalSearchIndex, MockSearchResult
...
from tests.testing import DummyHTTPClient, MockRequestsResponse
...
class TestStaticFileController(CirculationControllerTest):
    ...
    def test_image(self):
        directory = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", "resources", "images"))
